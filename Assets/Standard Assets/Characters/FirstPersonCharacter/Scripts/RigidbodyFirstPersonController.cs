...
namespace UnitySampleAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        {
            float distance = (Capsule.height / 2f - Capsule.radius) + advancedSettings.stickToGroundHelperDistance;
            if (Physics.SphereCast(transform.position, Capsule.radius, Vector3.down, out RaycastHit hitInfo, distance))
            {
        ...
        private void GroundCheck()
        {
            ...
            float distance = (Capsule.height / 2f - Capsule.radius) + advancedSettings.groundCheckDistance;
